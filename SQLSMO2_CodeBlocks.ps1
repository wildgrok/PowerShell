#========================================================================
# SQLSMO2_CodeBlocks.ps1
#version in C:\Users\jorgebe\Documents\powershell
...
# Last modified: 6/24/2019 commented sqlfileheader call (causing timeouts)
# Organization: 
# Filename:     
#========================================================================
...
$RestoreDatabase = 
{
  ...
  #needed to import GetLatestBackup
