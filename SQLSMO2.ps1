...
#Based on SQLSMO.ps1, adds jobs, now workflows
#Uses SQLSMO2_CodeBlocks.ps1 to import
#Called from SQLSMO2_WorkFlow.cmd
#Created 6/3/2019
#Last modified:
#7/31/2019: tested workflow version, no other changes
# 7/29/2019: fixed filter $filter = $dbname + '_*.bak' in $RestoreDatabase in SQLSMO2_CodeBlocks.ps1
