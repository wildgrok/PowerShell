...
# For demostration purposes includes both the ScriptBlocks and functions versions
...
$RestoreDatabase = 
{
  ...
  #It is needed to import ExecuteSQL, GetLatestBackup, GetBackupInfo used by $RestoreDatabase and $RestoreLogs
